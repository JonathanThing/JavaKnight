...
class Enemy extends Character {
 ...
 private int hitProjectileIndex;
 
 public int getHitProjectileIndex(){
   return this.hitProjectileIndex;
 }
 
 public void setHitProjectileIndex(int hitProjectileIndex){
   this.hitProjectileIndex = hitProjectileIndex;
 } 
 ...
 public void removeProjectile(Player player){
   
   enemyProjectiles.remove(player.getHitProjectileIndex());
